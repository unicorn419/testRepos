...
namespace FileProcessConfiguration.Controllers
{
    ...
    public class DataElementsController : Controller
    {
        ...
        [HttpGet]
        public IEnumerable<XMLItem> Get(string datafileName)
        {
        ...
        private List<XMLItem> getElement(string datafile)
        {
            ...
            doc.Load(filepath);
            Dictionary<string, XMLItem> dic = new Dictionary<string, XMLItem>();
            ...
            foreach (XMLItem x in dic.Values)
            {
                list.Add(x);
            }
        ...
        private void getObjects(XmlNode node, ref Dictionary<string, XMLItem> dic)
        {
